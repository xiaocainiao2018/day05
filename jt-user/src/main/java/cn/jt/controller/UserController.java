...
public class UserController {
	...
	public String add(@PathVariable String name,
			@PathVariable  String birthday,@PathVariable  String address) {
		return userFeign.add(name, birthday, address);
	}
	
	@RequestMapping("/user/update/{name}/{birthday}/{address}/{id}")
	public String update(@PathVariable String name,@PathVariable  String birthday, 
			@PathVariable String address,@PathVariable  Long id) {
